        ...
        for item in v:
            if item and item.strip():
                ...
                if len(stripped) > MAX_ITEM_LENGTH:
                    raise ValueError(
                        f"Item too long: {len(stripped)} chars "
                        f"(max {MAX_ITEM_LENGTH})"
                    )
    ...
    "properties": {
        ...
        "emotion": {
            ...
            "enum": [
                ...
                "disgust", "neutral", "frustration", "anxiety", "excitement"
            ],
            "description": "Primary emotion detected"
        },
        "stress_score": {
        ...
        "category": {
            "type": "string",
            "enum": [
                "workload", "deadline", "conflict", "praise",
                "feedback", "question", "update", "blocker",
